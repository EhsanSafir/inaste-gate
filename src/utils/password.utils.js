...
var PasswordUtils = /** @class */ (function () {
    ...
    PasswordUtils.prototype.generateHash = function (password) {
    ...
    PasswordUtils.prototype.generateSalt = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PasswordUtils.prototype.isMatch = function (password, hash) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
