...
export class StartupsResolver {
  ...
  @Mutation(() => Startup)
  updateStartup(@Args('updateStartupInput') updateStartupInput: UpdateStartupInput) {
    //TODO check is owner of this startup
    return this.startupsService.update(updateStartupInput.id, updateStartupInput);
  }
